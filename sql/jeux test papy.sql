...
INSERT INTO `xoops_quest_categories` (`IdCategorie`, `IdQuestionnaire`, `LibelleCategorie`, `LibelleCompltCategorie`, `OrdreCategorie`, `AfficherDroite`, `AfficherGauche`, `comment1`, `comment2`, `comment3`, `comment1mandatory`, `comment2mandatory`, `comment3mandatory`) VALUES (2, 1, '2. Entrepreneurial leadership', 'To what extent does this person', 2, 0, 1, 'This person is especially helpful in', 'This person could help more by', 'Other comments', 1, 1, 1);
INSERT INTO `xoops_quest_categories` (`IdCategorie`, `IdQuestionnaire`, `LibelleCategorie`, `LibelleCompltCategorie`, `OrdreCategorie`, `AfficherDroite`, `AfficherGauche`, `comment1`, `comment2`, `comment3`, `comment1mandatory`, `comment2mandatory`, `comment3mandatory`) VALUES (3, 1, '3. Problem solving leadership', 'To what extent does this person contribute to problem solving and help the team to ...', 3, 0, 1, 'This person is especially helpful in', 'This person could help more by', 'Other comments', 1, 1, 1);
INSERT INTO `xoops_quest_categories` (`IdCategorie`, `IdQuestionnaire`, `LibelleCategorie`, `LibelleCompltCategorie`, `OrdreCategorie`, `AfficherDroite`, `AfficherGauche`, `comment1`, `comment2`, `comment3`, `comment1mandatory`, `comment2mandatory`, `comment3mandatory`) VALUES (4, 1, '4. People leadership', 'To what extend does this person ....', 4, 0, 1, 'This person is especially helpful in', 'This person could help more by', 'Other comments', 1, 1, 1);
INSERT INTO `xoops_quest_categories` (`IdCategorie`, `IdQuestionnaire`, `LibelleCategorie`, `LibelleCompltCategorie`, `OrdreCategorie`, `AfficherDroite`, `AfficherGauche`, `comment1`, `comment2`, `comment3`, `comment1mandatory`, `comment2mandatory`, `comment3mandatory`) VALUES (5, 1, '5. General comment', 'To what extent.....', 7, 0, 1, 'Please describe the three best consulting skills employed by this person', 'Please describe the key consulting skills this person could work on and develop', 'Additional comments :', 1, 1, 1);
INSERT INTO `xoops_quest_categories` (`IdCategorie`, `IdQuestionnaire`, `LibelleCategorie`, `LibelleCompltCategorie`, `OrdreCategorie`, `AfficherDroite`, `AfficherGauche`, `comment1`, `comment2`, `comment3`, `comment1mandatory`, `comment2mandatory`, `comment3mandatory`) VALUES (6, 2, '1. Client leadership', 'To what extent does this person build Client impact and ...', 1, 0, 1, 'This person is especially helpful in', 'This person could help more by', 'Other comments', 1, 1, 1);
INSERT INTO `xoops_quest_categories` (`IdCategorie`, `IdQuestionnaire`, `LibelleCategorie`, `LibelleCompltCategorie`, `OrdreCategorie`, `AfficherDroite`, `AfficherGauche`, `comment1`, `comment2`, `comment3`, `comment1mandatory`, `comment2mandatory`, `comment3mandatory`) VALUES (7, 2, '2. Entrepreneurial leadership', 'To what extent does this person', 2, 0, 1, 'This person is especially helpful in', 'This person could help more by', 'Other comments', 1, 1, 1);
INSERT INTO `xoops_quest_categories` (`IdCategorie`, `IdQuestionnaire`, `LibelleCategorie`, `LibelleCompltCategorie`, `OrdreCategorie`, `AfficherDroite`, `AfficherGauche`, `comment1`, `comment2`, `comment3`, `comment1mandatory`, `comment2mandatory`, `comment3mandatory`) VALUES (8, 2, '3. Problem solving leadership', 'To what extent does this person contribute to problem solving and help the team to ...', 3, 0, 1, 'This person is especially helpful in', 'This person could help more by', 'Other comments', 1, 1, 1);
INSERT INTO `xoops_quest_categories` (`IdCategorie`, `IdQuestionnaire`, `LibelleCategorie`, `LibelleCompltCategorie`, `OrdreCategorie`, `AfficherDroite`, `AfficherGauche`, `comment1`, `comment2`, `comment3`, `comment1mandatory`, `comment2mandatory`, `comment3mandatory`) VALUES (9, 2, '4. People leadership', 'To what extend does this person ....', 4, 0, 1, 'This person is especially helpful in', 'This person could help more by', 'Other comments', 1, 1, 1);
INSERT INTO `xoops_quest_categories` (`IdCategorie`, `IdQuestionnaire`, `LibelleCategorie`, `LibelleCompltCategorie`, `OrdreCategorie`, `AfficherDroite`, `AfficherGauche`, `comment1`, `comment2`, `comment3`, `comment1mandatory`, `comment2mandatory`, `comment3mandatory`) VALUES (10, 2, '5. Study management', 'To what extent does this person.....', 5, 0, 1, 'This person is especially helpful in', 'This person could help more by', 'Other comments', 1, 1, 1);
INSERT INTO `xoops_quest_categories` (`IdCategorie`, `IdQuestionnaire`, `LibelleCategorie`, `LibelleCompltCategorie`, `OrdreCategorie`, `AfficherDroite`, `AfficherGauche`, `comment1`, `comment2`, `comment3`, `comment1mandatory`, `comment2mandatory`, `comment3mandatory`) VALUES (11, 2, '6. Personal impact', 'To what does this person....', 6, 0, 1, 'comments', '', '', 1, 1, 1);
INSERT INTO `xoops_quest_categories` (`IdCategorie`, `IdQuestionnaire`, `LibelleCategorie`, `LibelleCompltCategorie`, `OrdreCategorie`, `AfficherDroite`, `AfficherGauche`, `comment1`, `comment2`, `comment3`, `comment1mandatory`, `comment2mandatory`, `comment3mandatory`) VALUES (12, 2, '7. General comment', 'To what extent.....', 7, 0, 1, 'Please describe the three best consulting skills employed by this person :', 'Please describe the key consulting skills this person could work on and develop :', 'Additional comments :', 1, 1, 1);
...
INSERT INTO `xoops_quest_questionnaires` (`IdQuestionnaire`, `LibelleQuestionnaire`, `IdEnquete`, `DateOuverture`, `DateFermeture`, `NbSessions`, `Etat`, `ltor`, `SujetRelance`, `CorpsRelance`, `SujetOuverture`, `CorpsOuverture`, `FrequenceRelances`, `DerniereRelance`, `ReplyTo`, `Groupe`) VALUES (2, 'Ils font du chocolat en Suisse', 2, 1149072469, 1179183661, 3, 0, 0, 'sujet relance questionnaire', 'Merci de bien vouloir répondre dans les délais au questionnaire .......', 'Est-il meilleur qu''en France', 'Il semblerait que ......lorem ipsum et consorts', 0, 0, '', 2);
