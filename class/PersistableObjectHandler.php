...
* @modified by Herv? Thouzard (http://www.herve-thouzard.com)
* @copyright copyright (c) 2000-2004 XOOPS.org
* @package Kernel
*/

class MyXoopsPersistableObjectHandler extends XoopsObjectHandler {
    ...
    */
     ...
     *
     * @param object $criteria {@link CriteriaElement} conditions to be met
     * @param bool $id_key	name of the field to use as key
     * @param bool $as_object return an array of objects?
     *
     * @return array
     */
    function &getObjects2($criteria = null, $id_key = '', $as_object = true)
    {
        $ret = array();
        $limit = $start = 0;
        $sql = 'SELECT * FROM '.$this->table;
